# Bunker Notas — Master Agent Skills Index
...
- **Security:** Zero-Knowledge architecture. Local-first.
- **Workflow:** TDD mandatory. Clean code refactor after every green test.

## Master Skill Registry (Local)
